<?php
/**
* // Convert goto to varchar
*/
use Illuminate\Support\Facades\Schema;
use Illuminate\Database\Schema\Blueprint;
use Illuminate\Database\Migrations\Migration;

class CreateContentMetasTable6 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('content_metas', function (Blueprint $table) {
            ...
            $table->string('id_linked_content_meta');

            // Add a goto to support choicescript *goto checkpoints / hopping
            $table->string('goto');
